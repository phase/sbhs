...
Note that if you add \$20 to a character from the ROM, it will give you
...
with [Tile Layer Pro](Tile_Layer_Pro "wikilink"). This art includes
attacks, card text art, and more. I don't really know the format for
decompressed art (and it would be pretty useless if I told you; why
learn the format of decompressed art when you can just browse and edit
with TLP?) , so it will not be covered here.
...
80 = Double-tile\
81 - 8F = Glitchy tile R and MD, Y = 4 and on 81, X = 129 and goes up
from there\
90 = Double-tile M\
91 - 9F = Glitchy tile R and MD. Y = 4 and on 91, X = 145 and goes up
from there\
A0 = Double-Y glitchy tile\
A1 - AF = Glitchy tile R and MD; Y = 4 and on A1, X = 161 and goes up
from there\
...
Guy](Icy_Guy "wikilink")'s excellent program, [GBA Color
Picker](GBA_Color_Picker "wikilink"); the other option is to convert RGB
...
[Visual Boy Advance](Visual_Boy_Advance "wikilink") is THE ultimate tool
for ROM hacking, when combined with [Hex
Workshop](Hex_Workshop "wikilink"). This is especially true for Sonic
...
6.  If you want to distribute your results, make an IPS patch with
    [StealthPatch](StealthPatch "wikilink").
...
-   .sgm files are compressed. Heh, I spent a month trying to crack the
    format, only to find that they could be decompressed with WinZip.
    Here's how:
